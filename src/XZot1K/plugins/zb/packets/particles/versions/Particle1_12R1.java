...
public class Particle1_12R1 implements Particles
{

    public void displayParticle(Player player, Location loc, float x, float y, float z, int speed, String effect, int
            amount)
    {
