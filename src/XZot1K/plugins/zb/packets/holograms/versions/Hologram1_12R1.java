...
public class Hologram1_12R1 implements Hologram
{
    ...
    public Hologram1_12R1(String id, List<String> lines, double lineSpread, Location location)
    {
        setId(id);
        setLines(lines);
    ...
    {
        getEntityList().clear();
        Location location = getLocation().subtract(0, getLineSpread(), 0).add(0, getLineSpread() * getLines().size(),
                0);
